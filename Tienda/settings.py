...
SECRET_KEY = 'django-insecure-)koz(ix6!^*&q9gf7*kwtcik6i3x35f%r*70zb)9mgeadu8flz'
...
# Al loguearse correctamente, ir al catálogo
LOGIN_REDIRECT_URL = 'catalogo' 

# Al desloguearse, volver a la pantalla de login
